...
Dữ liệu trong repo được thu thập từ các tài liệu và trang thông tin công khai của **Trường Đại học Công nghệ - Đại học Quốc gia Hà Nội (UET-VNU)**. Corpus hiện gồm quy định học phí, học bổng, ký túc xá, đăng ký học phần và các thông báo hỗ trợ/sự kiện sinh viên; xem URL nguồn trong `src/task1_collect_legal_docs.py` và `src/task2_crawl_news.py`.
...
**Nguồn dữ liệu của dự án** (trang/tài liệu công khai UET-VNU):
...
- Đặt tên file rõ ràng theo nội dung UET, ví dụ: `quy-dinh-hoc-phi-uet.pdf`, `hoc-bong-uet.docx`, ...
...
# Convert PDF
result = md.convert("data/landing/legal/quy-dinh-hoc-phi-uet.pdf")
print(result.text_content)

# Convert DOCX
result = md.convert("data/landing/legal/hoc-bong-uet.docx")
```
...
- Mỗi file output có tên tương ứng, ví dụ: `quy-dinh-hoc-phi-uet.md`
...
flowchart TD
    ...
    UI --> G[Task 10<br/>Generation có citation]
    ...
    P --> K
    K --> G
    G --> A[Câu trả lời<br/>kèm citation]
    A --> UI

    D[(data/standardized<br/>legal + news)] --> S
    D --> L
    D --> P
```
...
| ----------------------- | ----------- | ------------------------ | ------------- |
| Nguyễn Ngọc Nam       | 2A202601561 | Team Leader & Architect  | Hoàn thành  |
| Vũ Tú Quỳnh          | 2A202601239 | Evaluation & QA Engineer | Hoàn thành  |
| Vũ Nguyễn Quốc Đạt | 2A202601199 | Data & Dense Search Dev  | Hoàn thành  |
| Nguyễn Hoàng Biên    | 2A202601233 | Sparse & Rerank Dev      | Hoàn thành  |
| Trần Thị Ngọc Lan    | 2A202601385 | Frontend & Chatbot Dev   | Hoàn thành  |
